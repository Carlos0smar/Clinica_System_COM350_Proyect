    ...
    <div class="col-8 p-4">
        ...
        <table class="table table-dark table-striped-columns">
            ...
            <tbody>
                ...
                $fecha=$_POST['fecha'];
                $fecha = $_SESSION['id'];
                $sql = "SELECT m.nombre as 'Nombre_Medico', m.apellido as 'Apellido_Medico', m.telefono as 'Telefono_Medico', c.fechacita as 'Fecha' FROM medico m INNER JOIN citas c ON c.medico_id = m.id INNER JOIN paciente p ON c.paciente_id = p.id WHERE c.medico_id = m.id and c.paciente_id = p.id";
